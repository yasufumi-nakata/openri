...
OpenRIは、システム開発そのものもCodex/Claude等のAI coding agentで進める前提です。そのため、AIの説明や自己評価ではなく、deterministic test、fixture、golden report、adversarial/metamorphic testで挙動を固定します。
